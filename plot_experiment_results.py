...
# Figure save path
FIG_SAVE_PATH = "plot_experiments_fig"
...
STD_PLOT_CONFIG = {
    ...
    'title_linear': 'Standard Deviation vs Time (θ={theta:.3f})',
    'title_loglog': 'Standard Deviation vs Time - Log Scale (θ={theta:.3f})',
    'xlabel': 'Time Step',
...
PROBDIST_PLOT_CONFIG = {
    ...
    'title': 'Final Probability Distribution (t={final_step}, θ={theta:.3f})',
    'xlabel': 'Position',
...
SURVIVAL_PLOT_CONFIG = {
    ...
    'title_linear': 'Survival Probability vs Time (θ={theta:.3f})',
    'title_loglog': 'Survival Probability vs Time - Log Scale (θ={theta:.3f})',
    'title_semilogy': 'Survival Probability vs Time - Semi-Log Scale (θ={theta:.3f})',
    'xlabel': 'Time Step',
