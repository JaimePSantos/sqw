...
PROCESS_LOG_DIR = os.path.join("logs", current_date, "generate_survival")
...
MASTER_LOG_FILE = os.path.join("logs", current_date, "generate_survival", "survival_generation_master.log")
